<script lang="ts" generics="Row">
	...
	let { rows, columns, caption, regionLabel, getRowId, operations = { kind: 'none' }, emptyMessage = 'No records.', stickyHeader = false }: Props = $props();
...
{#if validation.valid}
	<DataTableReady {rows} {columns} {caption} {regionLabel} {getRowId} {operations} {emptyMessage} {stickyHeader} />
{:else}
