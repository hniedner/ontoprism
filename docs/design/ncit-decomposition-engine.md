...
- **R101 conservation:** the historical two-run D77/D78 review, conservation, and comparator
  ...
  Each new run accounts for every stated R101 occurrence as projected,
  unchanged-unprojected, one-step-R82 covered, closure-only-R82 covered, or unresolved.
  Readiness reports the per-run D74 result; expert-demo publication does not withhold
  unresolved rows (D93).
