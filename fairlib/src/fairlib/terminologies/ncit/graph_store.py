...
restriction traversal (see :mod:`fairlib.terminologies.ncit.role_queries`); rendering
...
from fairlib.terminologies.namespaces import NCIT_NS, OWL_NS, RDFS_NS
from fairlib.terminologies.ncit import property_codes as pc
...
from fairlib.terminologies.oxigraph_http_client import OxigraphHttpClient, safe_iri
