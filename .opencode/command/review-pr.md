...
5. Run `pdm run verify` once at the end and report the result with the command output. The PR-body draft already lists every dropped finding and every deferral.
