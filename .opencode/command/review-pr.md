...
5. Run `pdm run verify` once at the end and report the result with the command output. List every dropped finding with its reason and every deferral with its issue number or comment URL; they go into the PR body.
