...
Classify findings as **blocker**, **finding** (fixed in this PR unless it is a major out-of-scope finding; see "What a finding becomes" in `AGENTS.md`) or **suggestion** (addressed in this PR), and state whether this dimension has converged. A handful of well-chosen mutations is enough; do not mutate everything. Never fix code, leave an edit, stage, commit, or touch a PR.
