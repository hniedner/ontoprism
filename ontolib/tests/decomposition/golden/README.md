...
Use the exact manifest path and identity printed by `pdm run agent-replay decompose-current`;
placeholders are not accepted. The retired run-ID-only form completed against the persisted
