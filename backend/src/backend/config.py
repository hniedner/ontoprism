...
class Settings(BaseSettings):
    ...
    # Independent release evidence for embedding completeness. The publisher requires
    # exact agreement with the source it enumerates; update deliberately on source bump.
